...
class PortfoliosTest < ApplicationSystemTestCase
  ...
  test "creating a Portfolio" do
    ...
    fill_in "Amount", with: @portfolio.amount
    fill_in "Buy date", with: @portfolio.buy_date
    fill_in "Buy price", with: @portfolio.buy_price
    fill_in "Name", with: @portfolio.name
    fill_in "Note", with: @portfolio.note
